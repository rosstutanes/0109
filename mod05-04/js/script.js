...
document.getElementById("clear1").addEventListener("click",erase1);
document.getElementById("clear2").addEventListener("click",erase2);
document.getElementById("clear3").addEventListener("click",erase3);
	function erase1 (){
